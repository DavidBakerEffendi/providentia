...
from providentia.repository.analysis_tables import tbl_kate, tbl_review_trends, tbl_city_sentiment, tbl_sim1, tbl_sim2, tbl_sim3

__all__ = ['tbl_analysis', 'tbl_benchmark', 'tbl_databases', 'tbl_datasets', 'tbl_queries', 'tbl_kate',
           'tbl_review_trends', 'tbl_city_sentiment', 'tbl_sim1', 'tbl_sim2', 'tbl_sim3']
