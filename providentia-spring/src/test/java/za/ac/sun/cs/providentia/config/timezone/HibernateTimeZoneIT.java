package za.ac.sun.cs.providentia.config.timezone;

import za.ac.sun.cs.providentia.ProvidentiaApp;
import za.ac.sun.cs.providentia.repository.timezone.DateTimeWrapper;
import za.ac.sun.cs.providentia.repository.timezone.DateTimeWrapperRepository;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM prv_date_time_wrapper where id=%d", fieldName, id);
    }
