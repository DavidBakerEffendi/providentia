...
import { PrvHealthCheckComponent } from 'app/admin/health/health.component';
import { PrvHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
  describe('PrvHealthCheckComponent', () => {
    let comp: PrvHealthCheckComponent;
    let fixture: ComponentFixture<PrvHealthCheckComponent>;
    let service: PrvHealthService;

    beforeEach(async(() => {
      TestBed.configureTestingModule({
        imports: [ProvidentiaTestModule],
        declarations: [PrvHealthCheckComponent]
      })
        .overrideTemplate(PrvHealthCheckComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(PrvHealthCheckComponent);
      comp = fixture.componentInstance;
      service = fixture.debugElement.injector.get(PrvHealthService);
    });
