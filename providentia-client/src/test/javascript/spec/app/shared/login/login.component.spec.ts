...
import { PrvLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
  describe('LoginComponent', () => {
    let comp: PrvLoginModalComponent;
    let fixture: ComponentFixture<PrvLoginModalComponent>;
    ...
    beforeEach(async(() => {
      TestBed.configureTestingModule({
        ...
        declarations: [PrvLoginModalComponent],
        providers: [
          FormBuilder,
          {
        ...
        .overrideTemplate(PrvLoginModalComponent, '')
        .compileComponents();
    }));

    beforeEach(() => {
      fixture = TestBed.createComponent(PrvLoginModalComponent);
