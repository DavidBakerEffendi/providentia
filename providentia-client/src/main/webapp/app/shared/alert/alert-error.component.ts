...
export class PrvAlertErrorComponent implements OnDestroy {
  alerts: any[];
  ...
  constructor(private alertService: JhiAlertService, private eventManager: JhiEventManager) {
    ...
    this.cleanHttpErrorListener = eventManager.subscribe('providentiaApp.httpError', response => {
      let i;
