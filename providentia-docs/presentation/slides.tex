...
\lstinputlisting[
    language=gsql,
    caption={A GSQL query that returns ``recommending users'' of Kate (a user in the dataset). These are users who have reviewed restaurants that Kate has also been to with a rating above 3 stars.}
    ]
...
\framepic{img/results/katePlotSetup1.pdf}

\framepic{img/results/reviewsPlotSetup1.pdf}
...
% \framepic{./img/results/cityPlotSetup1.pdf}
...
\begin{frame}
    \tikz[overlay,remember picture] \node[opacity=1, at=(current page.center)] {
      \includegraphics[width=\paperwidth]{./img/results/cityPlotSetup1.pdf}};
\end{frame}
