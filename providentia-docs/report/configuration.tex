...
\lstdefinelanguage{gremlin}
{
    ...
    morekeywords = {
        has, outE, order, by, desc, asc, inV, select, circle, gt, lt, leq, as, geoWithin, hasLabel, out, except, V, where, values, neq, eq, valueMap, limit, in, dedup, fold, unfold, inE, between, union, filter, get, value, atZone, of, getMonthValue, toLocalDate, aggregate, mean, groupCount, math, is, count
    },
...
\lstdefinelanguage{gsql}
{
	...
	keywordstyle=\color{keyword}\bfseries,
	ndkeywords={SetAccum, SumAccum, AvgAccum, ListAccum, HeapAccum, STRING, INT, DOUBLE, VERTEX, EDGE, tuple, DATETIME, FLOAT},
    ndkeywordstyle=\color{relation},
    sensitive=true,
    morestring=*[d]{"},
}
