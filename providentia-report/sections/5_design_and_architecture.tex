...
The first motivation towards using a Python back end is that the text in the reviews can be 
...
Although this investigation does not explore the applications of machine learning models on
